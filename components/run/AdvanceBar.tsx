    ...
    <div className="sticky bottom-0 z-30 border-t border-ink/12 bg-bg/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-5 py-3">
        <div className="flex items-center gap-2">
          <button type="button" onClick={onQuit} className="eyebrow text-ink-dim transition-colors hover:text-brick">
            End run
          </button>
          {canRetire && (
            <button type="button" onClick={onRetire} className="flex items-center gap-1 eyebrow text-ink-dim transition-colors hover:text-accent">
        ...
        <div className="flex items-center gap-3">
          ...
          <NeonButton variant="primary" size="md" onClick={onAdvance} disabled={blocked}>
